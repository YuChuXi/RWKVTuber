...
def face_landmarker(input, output, detector, id):
    ...
    torch.save(torch.tensor(face).bfloat16(), f"{output}.pth")
...
if __name__ == "__main__":
    ...
    def dland(i):
        ...
        base_options = python.BaseOptions(
            model_asset_path=model_path, delegate=mp.tasks.BaseOptions.Delegate.CPU if i > 8 else mp.tasks.BaseOptions.Delegate.GPU
        )
